 ...
 * @since 1.0
 */
public class TestBitronixTransactionSetDataSourceByJava {
	...
	public void init(){
    	...
    	cfg.configure("hibernate-bitronix-setdatasourcebyjava.cfg.xml") ; 
    	ServiceRegistry sr = new ServiceRegistryBuilder()
    			.applySettings(cfg.getProperties())
    			.applySetting(AvailableSettings.DATASOURCE, ds1) //set dataSource by java code
