...
public class DataSourceUtils {
	...
	public static PoolingDataSource createTestDataource() {
		PoolingDataSource ds = new PoolingDataSource() ; 
		Properties p = new Properties() ; 
		p.setProperty("url", "jdbc:mysql://127.0.0.1:3306/testjbpm630?useUnicode=true&characterEncoding=utf8&autoReconnect=true&pinGlobalTxToPhysicalConnection=true&useSSL=false") ; 
