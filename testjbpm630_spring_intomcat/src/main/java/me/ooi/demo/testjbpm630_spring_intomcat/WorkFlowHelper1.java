...
@Component
public class WorkFlowHelper1 implements WorkFlowHelper{
	...
	@PostConstruct
	private void init(){
		System.out.println("WorkFlowHelper1");
	...
	private AbstractAuditLogger getOrCreateAuditLogger() {
		if( auditLogger == null ) {
			...
			auditLogger = AuditLoggerFactory.newJPAInstance(env.getEnvironment()) ; 
		}
		return auditLogger;
	}
